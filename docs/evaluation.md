...
digit and cannot contain `..`. At least one expected fact is required; an empty fact set cannot make
an otherwise wrong recorded answer pass correctness vacuously.
